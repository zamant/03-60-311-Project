...
$error_flag=validate_all(array('title','author','price','subject','description','isbn','image_url'));
...
if (!$error_flag)
{
	$book = newBook($_POST['title'],currentUser()['ID'],$_POST['author'],$_POST['price'],$_POST['subject'],$_POST['description'],$_POST['isbn'],$_POST['image_url']);
	if (!$book){
		$error_flag = TRUE;
	}else{
